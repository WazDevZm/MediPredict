...
#breast_cancer = pickle.load(open(f'{working_dir}/saved_models/parkinsons_model.sav', 'rb'))
...
with st.sidebar:
    selected = option_menu('MediPredict',
                           ...
                           ['Home', 'Diabetes Prediction',
                            ...
                            'Parkinsons Prediction','Kidney Disease Prediction', 'About', 'BMI Calculator'], #'Breast Cancer'],
                           menu_icon='hospital-fill',
                           icons=['home', 'activity', 'heart', 'person', 'activity', 'person', 'heart','activity'],
                           default_index=0)
...
if selected == 'Home':
    st.markdown("""
    <h1 style="text-align: center;">Welcome to MediPredict (Disease Prediction Using ML)</h1>
